...
return [
    ...
    "plugin.firefox.1"    => 'En su navegador, haga clic en "<i class =" fa fa-ellipsis-h "> </i>" en la esquina superior derecha de la barra de direcciones para abrir el menú de acción de la página y luego haga clic en "Agregar motor de búsqueda" ( ver foto)',
    "plugin.firefox.2"    => 'Abre la configuración de Firefox. Para esto, ingrese "about: preferences" en la barra de direcciones. Ahora ingrese "motor de búsqueda" en el cuadro de búsqueda en la esquina superior derecha. En la sección "Motor de búsqueda predeterminado", seleccione MetaGer (ver imagen).',
    ...
    "plugin.IE.9"         => "Haga click arriba derecha en <i class=\"fa fa-cog\"></i> y abre \"Opciones de internet\"",
    ...
    "plugin.edge.7"       => "Haga click arriba derecha en el navegador en <i class=\"fa fa-ellipsis-h\"></i> y abre  \"Configuraciones\"",
