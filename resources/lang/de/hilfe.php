...
return [
    ...
    "sucheingabe.hint" => "Die im folgenden verwendeten Suchen und Webseiten sind lediglich Beispiele. Sie müssen diese in der Praxis durch ihre eigenen ersetzen.",
    ...
    "grossklein.3" => "großschreibung",
    "grossklein.4" => "sollte die gleichen Ergebnisse liefern wie",
    "grossklein.5" => "GROẞSCHREIBUNG",
    ...
    "domains.showcase.menu.1" => "Wenn Sie auf dieses Symbol klicken, erscheint ein Menü mit folgenden Optionen (teilweise erscheinen nicht alle):",
    ...
    "datenschutz.faktencheck.heading" => "Fakten-Prüfung gegen Fake-News:",
    ...
    "datenschutz.2" => "Wir verwenden weder Cookies noch Session-IDs und speichern IP-Adressen lediglich für einen stark begrenzten Zeitraum, um uns vor Bot-Attacken zu schützen. Weil wir die Thematik Datenschutz für extrem wichtig halten, haben wir auch Möglichkeiten geschaffen, die Ihnen helfen können, hier ein Höchstmaß an Sicherheit zu erreichen: den MetaGer-TOR-Hidden-Service und unseren anonymisierenden Proxyserver.",
    ...
    "searchinsearch.1" => "Sie können ein Ergebnis für die weitere Verwendung Zwischenspeichern, indem Sie im \"MEHR\"-Menü eines Ergebnisses den Punkt \"ERGEBNIS IN TAB SPEICHERN\" wählen. Hierdurch wird das jeweilige Ergebnis in einem separaten Speicher abgelegt. Die gespeicherten Ergebnisse finden Sie rechts neben den Ergebnisse direkt unter den Quicktips. Dort können Sie die gespeicherten Ergebnisse nach Schlüsselworten filtern oder umsortieren lassen.",
];
