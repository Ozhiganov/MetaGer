...
@section('content')
	...
	@if ($site !== '')
		...
		<form class="metager-searchform" action="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/") }}/meta/meta.ger3" method="GET">
			<a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), "/") }}"><p class="mg-logo" title="{{ trans('sitesearch.generated.2') }}" alt="MetaGer">MetaGer</p></a>
